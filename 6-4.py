...
police_car = PoliceCar ('"ДПС"', '"серебристо-синяя"', 80)
police_car.go()
...
work_car = WorkCar ('"Бетономешалка"', '"зеленая"', 40)
work_car.go()
work_car.turn(1)
...
sport_car = SportCar ('"Спортседан"', '"синий"', 140)
sport_car.go()
sport_car.turn(1)
...
town_car = TownCar('"Nissan"', '"белый"', '"50"')
town_car.go()
town_car.turn(0)
